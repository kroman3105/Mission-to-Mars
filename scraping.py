...
def scrape_all():
    browser = Browser('chrome', executable_path='C:/chromedriver/chromedriver.exe', headless=True)
    
    # set news title and paragraph variables
    news_title, news_paragraph = mars_news(browser)

    # Run all scrpaing functions and store results in dictionar
    data = {
        "news_title": news_title,
        'news_paragraph': news_paragraph,
        'featured_image': featured_image(browser),
        'hemispheres': hemishpere_image(browser),
        'facts': mars_facts(),
